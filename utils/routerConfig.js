export const  userButtonConfig = {
	personCenter: '/pages/user/index', 			// 个人中心
	personManage: '/pages/user/rolemanage',		// 人员管理
	companyInfomation: '/pages/businessDoc/index',						// 企业资料
	messageManage: '',							// 消息管理
	businessNode: '/pages/list/businessNoteList', 			// 业务记录
	// companyManage: '/pages/list/companyManageList', 			// 单位管理
	companyManage: '/pages/user/deptmanage', 			// 单位管理
	businessCheck: '/pages/list/businessCheckList', 	// 业务审核
	documentInfomation: '',      						//文档管理
}
...
// /pages/user/identity -- 登记单位
// /pages/user/addauthorization -- 授权管理
// /pages/user/changerole -- 个人信息
// /pages/user/deptmanage -- 添加新的授权单位
// /pages/user/index -- 个人中心
// /pages/user/qualifications -- 资质证明
// /pages/user/roleedit -- 人员编辑
// /pages/user/rolemanage -- 人员管理
