	...
	<view class="overview_species">
		...
		<view class="chart-box">
			...
			<view class="chart">
				...
				<view v-if="controlidx==1 || controlidx==2"
					style="position: absolute;right: 30rpx;bottom: 20rpx;z-index: 9;" class="flex-baseline">
...
<script>
	...
	export default {
		data() {
			return {
				...
				titlearr: [{
					...
					name: '物种台账',
					url: '/pages/standingbook/species/specieslist'
				}],
				startTime: '',
				endTime: '',
				maintablist: [],
		...
		computed: {
			bistype() {
				if (this.chartcontrol1[this.controlidx].name == '业务') {
					return this.controlbisidx == 1 ? '业务-动物' : '业务-物种'
				} else if (this.chartcontrol1[this.controlidx].name == '企业') {
					return this.controlbisidx == 1 ? '企业-动物' : '企业-物种'
				} else {
