			...
			<view class="form-itemblock">
				...
				<view class="">
					<view class="numinfo flex">
						<text style="width: 80rpx;">数量</text>
	...
	export default {
		...
		methods: {
			...
			addanimal() {
				...
				let url = '/pages/business/codelist?yewuid=80019&backflg=true'
				if (relationid.length) {
					url = `/pages/business/codelist?yewuid=80019&backflg=true&relationid=${relationid.join(',')}`
				}
				uni.navigateTo({
					url,
					events: {
