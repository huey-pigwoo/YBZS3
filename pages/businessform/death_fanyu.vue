<template>
	<view class="death_fanyu container">
			...
			<view class="form-itemblock">
				...
				<view class="">
					<view class="numinfo flex">
						...
						<input @blur="inputblur(index)" type="number" style="margin-left: 0;" class="num-input"
	...
	export default {
		...
		methods: {
			...
			addanimal() {
				...
				let url = '/pages/business/codelist?yewuid=80021&backflg=true'
				if (relationid.length) {
					url = `/pages/business/codelist?yewuid=80021&backflg=true&relationid=${relationid.join(',')}`
				}
				uni.navigateTo({
					url,
					events: {
